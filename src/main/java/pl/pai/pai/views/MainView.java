...
public class MainView extends VerticalLayout{
	...
	void postConstruct() {
		...
		quizLayout.add(new H2("Ostatnio dodane"));
		...
		quizLayout.add(new H2("Najczęściej rozwiązywane"));
		...
		surveyLayout.add(new H2("Ostatnio dodane"));
		...
		surveyLayout.add(new H2("Najczęściej rozwiązywane"));
